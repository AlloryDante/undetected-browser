...
async function test() {
  ...
  await page.randomSleep(200, 400);
  //await page.enableMouseDebugWindow(); //doesnt properly work on "https://reviewer.eugenebos.com/automation-test"
  ...
  const fingerprint = await page.checkFingerprint(true);
